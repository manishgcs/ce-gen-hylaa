...
def define_ha(settings, usafe_r=None):
    ...
    a_matrix = np.array([[2.6207, -1.1793, 0.65705], [2, 0, 0], [0, 0.5, 1]], dtype=float)

    b_matrix = np.array([[8], [0], [0]], dtype=float)
    ...
    if usafe_r is None:
        ...
        # exp 1
        usafe_set_constraint_list.append(LinearConstraint([0.0, 1.0, 0.0], -6.0))
