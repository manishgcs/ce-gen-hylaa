...
def define_ha(settings, usafe_r=None):
    ...
    a_matrix = np.array([[23.6667, -1], [1, 0]], dtype=float)

    b_matrix = np.array([[3], [0]], dtype=float)
    ...
    if usafe_r is None:
        ...
        # exp 1
        usafe_set_constraint_list.append(LinearConstraint([-1.0, 0.0], -1.25))
...
if __name__ == '__main__':
    ...
    # mid-order = +3
    # random: [16, 22, 19, 26, 11, 29, 12, 14, 9, 7, 17, 2, 15, 1, 6, 13, 0, 5, 18, 10, 3, 20, 27, 8, 4, 24, 25, 21,
    # 23, 28]
