...
def define_ha(settings, usafe_r=None):
    ...
    if usafe_r is None:
        ...
        # exp 1
        usafe_set_constraint_list.append(LinearConstraint([0.0, -1.0, 0.0, 0.0], -3.9))
...
def define_settings():
    ...
    settings = HylaaSettings(step=0.4, max_time=100.0, disc_dyn=False, plot_settings=plot_settings)
